...
@section('title', 'Tambah Periode Audit - SIMUTU POLIJE')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1 fw-bold">Tambah Periode Audit</h4>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form action="{{ route('master-data.periode-audit.store') }}" method="POST">
            @csrf
            <div class="row">
